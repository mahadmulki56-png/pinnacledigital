        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-9 flex flex-col items-start">
            <h2
              ...
              className="font-display font-medium text-2xl sm:text-4xl md:text-5xl lg:text-[54px] tracking-tight text-[#f4f7f4] light:text-[#0d140f] leading-[1.18] max-w-4xl"
            >
            ...
            <p className="mt-6 text-base sm:text-lg text-[#a0ada3] light:text-[#4a594e] max-w-2xl leading-relaxed">
            ...
            <div className="mt-8">
              <button
                ...
                className="group inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-[#121614] light:bg-[#0d140f] border border-white/15 light:border-black/15 text-sm font-semibold text-[#f4f7f4] hover:border-[#39ff88]/50 hover:bg-[#151c18] transition-all duration-300 shadow-md"
              >
