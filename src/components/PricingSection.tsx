            ...
            >
              ...
              <div>
                <div className="flex items-center justify-between">
                  <span className="text-sm font-semibold text-[#a0ada3] light:text-[#4a594e]">
                    {plan.name}
                  </span>
                ...
                <div className="mt-4 flex items-baseline gap-1">
                  <span className="font-display font-extrabold text-4xl sm:text-5xl text-[#f4f7f4] light:text-[#0d140f] tracking-tight">
                    {plan.price}
                  </span>
                  <span className="text-sm text-[#a0ada3] light:text-[#78897d] font-medium">
                    {plan.period}
                  </span>
                </div>

                <p className="mt-4 text-xs sm:text-sm text-[#a0ada3] light:text-[#4a594e] leading-relaxed pb-6 border-b border-white/[0.08] light:border-black/[0.08]">
                  {plan.description}
                </p>

                <div className="mt-6">
                  <span className="text-xs font-semibold text-[#f4f7f4] light:text-[#0d140f] uppercase tracking-wider">
                    What's Included:
                  </span>
              ...
              <div className="mt-10 pt-4">
                <button
                  ...
                  className={`w-full group inline-flex items-center justify-center gap-3 py-3.5 px-6 rounded-full font-semibold text-sm transition-all duration-300 ${
                    plan.highlighted
